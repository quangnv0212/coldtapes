...
import SunHeaderComponent from "../components/SunHeaderComponent";
  ...
  return (
    <main className="bg-grey-100 overflow-x-hidden">
      <div className="md:p-8 h-[86vh] md:h-svh">
        <div className="bg-white rounded-b-2xl md:rounded-xl bg-header-image bg-center md:bg-top bg-no-repeat bg-cover h-full justify-center flex items-end">
          <SunHeaderComponent />
            ...
            <div className="mx-auto max-w-7xl flex justify-center pb-8 items-end h-full">
              <div className="text-center">
                ...
                <div className="flex flex-row gap-x-3 max-w-2xl mx-auto mt-5">
                  ...
                  />
                  <a
                    href={"/register?sun=1&email=" + email}
      ...
      >
        ...
        <p className="text-black font-extrabold text-2xl pb-12 leading-10 block">
          Check out File 001: Operation Antelope below and then scroll down for
          an exclusive offer for The Sun readers!
        </p>
      ...
      <div className=" bg-center md:bg-top bg-no-repeat bg-cover h-full px-8 py-16 md:hidden overflow-hidden">
        ...
        <div className="relative w-full flex justify-center items-center mt-20 h-[500px] px-20">
          ...
          <div className="bg-black max-w-[20rem] w-full absolute h-full rounded-2xl  p-8 flex flex-col justify-between">
            ...
            <p className="text-white mt-3 mb-5">
              The Sun Reader Exclusive! For just £5 you can access the full
              series now, totally ad-free and your ticket to enter the draw to
              win £10,000. Plus, receive the Official Cold Tapes Detective Pack
              with extras to help you crack the case.
            </p>
      ...
      <div className="bg-home-image bg-center md:bg-top bg-no-repeat bg-cover h-full px-8 py-32 hidden md:block">
        ...
        <div className="relative h-[700px] w-full flex justify-center items-center mt-12">
          <div className="bg-red-500 sm:max-h-[560px] h-full max-w-[40rem] w-full absolute rotate-[-10deg] rounded-xl top-20"></div>
          <div className="bg-black max-w-[40rem] absolute rounded-xl  top-16 p-10">
            ...
            <p className="font-roboto text-white font-semibold mt-6 text-lg mb-5">
              The Sun readers can access all of the following for just £5.00:
            </p>
            ...
            <dl>
              ...
              <p className="text-white mt-6 mb-4">
                <span className="font-bold">PLUS: </span>The Official COLD TAPES
                Detective Pack:
              </p>
              <dt className="font-roboto text-white font-semibold  flex mb-4">
                <svg
                ...
                Transcripts of all the evidence
              </dt>
              <dt className="font-roboto text-white font-semibold  flex mb-4">
                <svg
                  width="24"
              ...
              <dt className="font-roboto text-white font-semibold  flex mb-4">
                ...
                A crime-solving matrix designed by an ex-murder squad detective.
              </dt>
              <p className="font-roboto text-white font-semibold mt-5">
