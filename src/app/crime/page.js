  ...
  return (
    <main className="bg-grey-100">
      ...
      >
        ...
        <a
          href="/register"
          className="bg-red-500 border border-black py-4 px-6 rounded-lg text-left font-semibold md:hidden"
        >
          Start your investigation
        </a>
      </div>
      <div className=" bg-center md:bg-top bg-no-repeat bg-cover h-full px-8 py-16 md:hidden">
        ...
        <div className="relative w-full flex justify-center items-center mt-4 h-[420px] px-20">
          <div className="bg-red-500 h-full max-w-[20rem] w-full absolute rotate-[-14deg] rounded-2xl top-20"></div>
          <div className="bg-black max-w-[20rem] w-full absolute h-full rounded-2xl top-20 p-8 flex flex-col justify-between">
